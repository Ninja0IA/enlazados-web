...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- CAMBIO 1: Nueva función para generar la sinopsis ---
    function generarSinopsis(html, limitePalabras) {
        ...
        // Si el texto es más corto que el límite, devolverlo tal cual
        if (palabras.length <= limitePalabras) {
            return textoPlano;
        }

        // Recortar al límite de palabras y añadir puntos suspensivos
    ...
    function crearTarjeta(nota) {
        ...
        // --- CAMBIO 2: Usamos la función generarSinopsis() en lugar de nota.cuerpo ---
    ...
    function mostrarArticulo(id) {
        ...
        // --- CAMBIO 3: Asegurarnos que en la vista completa se muestre el cuerpo completo (nota.cuerpo) ---
    ...
    function calcularTiempoLectura(texto) {
        ...
        // --- CAMBIO 4: Calcular tiempo de lectura basado en texto plano ---
        const div = document.createElement('div');
        div.innerHTML = texto;
        const textoPlano = div.textContent || div.innerText || "";
